...
public record CommentData(String authorDisplayName, String authorProfileImageURL, String authorChannelUrl, String textDisplay, String videoId, String parentId ,Long likeRating, DateTime publishedAt) {
}
